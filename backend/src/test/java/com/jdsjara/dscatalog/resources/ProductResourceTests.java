package com.jdsjara.dscatalog.resources;
...
import com.jdsjara.dscatalog.services.ProductService;
...
import com.jdsjara.dscatalog.tests.TokenUtil;
...
public class ProductResourceTests {
	...
	public void findByIdShouldReturnProductWhenIdExists() throws Exception {
		...
		// ANALISA SE O STATUS É OK
		result.andExpect(status().isOk());
		
		// ANALISA O CORPO DA RESPOSTA - O "$" É PARA ACESSO AOS CAMPOS DO JSON
		result.andExpect(jsonPath("$.id").exists());
		result.andExpect(jsonPath("$.name").exists());
		result.andExpect(jsonPath("$.description").exists());
